...
define_builtins! {
    ...
    /// peek - Read byte from memory at address
    Peek => "peek",
    /// poke - Write byte to memory at address
    Poke => "poke",
    /// peek32 - Read 32-bit word from memory at address
    Peek32 => "peek32",
    /// poke32 - Write 32-bit word to memory at address
    Poke32 => "poke32",
    ...
    /// gpio-set - Set bit in GPIO register
    GpioSet => "gpio-set",
    /// gpio-clear - Clear bit in GPIO register
    GpioClear => "gpio-clear",
    /// gpio-toggle - Toggle bit in GPIO register
    GpioToggle => "gpio-toggle",
    
    // Bit manipulation
    /// bit-set? - Check if bit is set in value
    BitSetP => "bit-set?",
