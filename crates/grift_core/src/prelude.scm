...
;;; True for exact integers, exact rationals, and finite floats
(define (rational? x)
  (and (number? x)
       (if (inexact? x) (finite? x) #t)))

;;; (complex? x) - Check if value is complex (R7RS §6.2.6)
;;; All numbers are complex in R7RS
...
;;; Now implemented as native builtins with full Unicode support
;;; via icu4x. The following are registered as Builtin variants:
;;;   char-alphabetic?, char-numeric?, char-whitespace?,
;;;   char-upper-case?, char-lower-case?, digit-value,
;;;   char-foldcase, char-ci=?, char-ci<?, char-ci>?,
;;;   char-ci<=?, char-ci>=?
;;; ============================================================

;;; ============================================================
;;; String Case Operations (R7RS Section 6.7)
;;; Now implemented as native builtins with full Unicode support:
;;;   string-upcase, string-downcase, string-foldcase, string-ci=?
;;; ============================================================
