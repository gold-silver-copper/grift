...
This is a Rust workspace containing a minimal Lisp implementation (named "grift") built on a custom arena allocator.

## Critical Requirements

**This is a `no_std`, `no_alloc` Lisp implementation.** Only the REPL crate (`grift_repl`) may use `std`.
